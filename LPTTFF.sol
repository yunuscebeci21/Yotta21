  ...
  KeeperCompatibleInterface
{
  ...
  function setYearlyValue(uint256 _yearlyValue) external {
    require(
      ...
      "only timelock for otta dao and mesh dao"
    );
    require(_yearlyValue > 0.05*10**18 && _yearlyValue < 1*10**18);
    yearlyValue = _yearlyValue;
  }
