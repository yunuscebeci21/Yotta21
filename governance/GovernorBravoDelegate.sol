  ...
  GovernorBravoEvents
{
   ...
   * @param otta_ The address of the Otta token
  ...
  function initialize(
    ...
    require(
      otta_ != address(0),
      "GovernorBravo::initialize: invalid otta address"
    );
    require(
  ...
  function propose(
    ...
    require(
      otta.getPriorVotes(msg.sender, sub256(block.number, 1)) >
        proposalThreshold,
  ...
  function cancel(uint256 proposalId) external {
    ...
    require(
      msg.sender == proposal.proposer ||
        otta.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
        proposalThreshold,
  ...
  function castVoteInternal(
    ...
    uint96 votes = otta.getPriorVotes(voter, proposal.startBlock);
   ...
   */
  function _initiate(uint256 _proposalCount) external {
