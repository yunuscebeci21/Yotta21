...
interface IPrice{
    ...
    /// @notice LPTTFF price calculate with the amount of ether in the Protocol
    function getLPTTFFPrice(uint256 _ethAmount) external returns (uint256,uint256,uint256);
